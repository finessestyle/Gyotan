...
const config: ExpoConfig = {
  ...
  android: {
    ...
    permissions: ['ACCESS_FINE_LOCATION', 'CAMERA', 'READ_EXTERNAL_STORAGE', 'WRITE_EXTERNAL_STORAGE']
  },
  extra: {
    eas: {
    ...
    expoPublicFbAndroidAppId: process.env.EXPO_PUBLIC_FB_ANDROID_APP_ID,
